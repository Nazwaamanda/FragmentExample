...
import com.nazwa.fragmantexample.databinding.BookTittlesBinding

class BookTitle : Fragment(), View.OnClickListener {
    private var _binding: BookTittlesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BookTittlesBinding.inflate(inflater, container, false)
        return binding.root
    }
